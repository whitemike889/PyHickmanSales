...
def get_listings(*, category: Parameter[Category] = None, vehicle_type: Parameter[VehicleType] = None, make: Parameter[str] = None, model: Parameter[str] = None, year: Parameter[int] = None, **kwargs) -> List[Vehicle]:
    ...
    listings = requests.get(BASE_URL, params=params, headers={"User-Agent": "PyHickmanSales V1.2.0 (https://github.com/nint8835/PyHickmanSales)"})
    ...
    for car in cars:
        ...
        vehicle = Vehicle(
            ...
            data_dict["vin"],
            data_dict["year"],
            data_dict["featuredPrice"],
            data_dict["salePrice"],
            data_dict["exteriorColor"],
            data_dict["stockNumber"],
            url
        )
